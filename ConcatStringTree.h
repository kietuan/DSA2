...
private:
    ...
    {
    public:
        LitStringHash::LitString* data{}; //chỉ nắm giữa 1 tham chiếu, đến đối tượng nằm trong bảng băm
        int length{};
        int leftLength{};
        int rightLength{}; 
    ...
    private:
        ...
        Node(LitStringHash::LitString* p): data{p}, left{nullptr}, right{nullptr} //Node này trỏ tới p
        {
            data->numofLink += 1;
        }
        Node() = delete;
